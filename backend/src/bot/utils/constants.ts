...
Примечание: данные взяты из открытых источников и предоставлены исключительно в ознакомительных целях. Фактическое состояние погоды может отличаться`;
};
...
Примечание: данные взяты из открытых источников и предоставлены исключительно в ознакомительных целях. Фактический курс валют в обменниках и банках может отличаться.`;
};
