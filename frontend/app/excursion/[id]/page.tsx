    ...
    <div className="container mx-auto px-4 py-8 pt-28">
      ...
      {excursion.photoLinks.length > 0 && (
        <div className="mb-4 flex flex-col items-center">
          <div className="relative w-full md:w-[50%] h-[300px] md:h-[500px] bg-white/50 backdrop-blur-lg">
            <Image
      ...
      {/* Описание экскурсии */}
      <div className="bg-white/50 backdrop-blur-lg shadow-lg rounded-lg p-4 mb-4">
