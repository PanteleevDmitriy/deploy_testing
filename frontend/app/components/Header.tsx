      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-2">
          ...
          <div className="flex-grow flex justify-center">
            <Link href="/" className="text-xl sm:text-2xl lg:text-4xl font-bold text-white hover:text-teal-100 transition duration-300">
              SEAWIND travel
            </Link>
          </div>
          <div className="flex items-center space-x-4">
            ...
            <Link href="/auth" className="bg-white text-black px-4 py-2 rounded-full hover:bg-teal-100 transition duration-300 text-sm">
              Войти
            </Link>
          </div>
        </div>
        <nav className="py-2 flex justify-between items-center">
          ...
          <Link href="/contact" className="bg-white text-black px-4 py-2 rounded-full hover:bg-teal-100 transition duration-300 shadow-md text-sm">
            Связаться с нами
          </Link>
        </nav>
        {isMobileMenuOpen && (
