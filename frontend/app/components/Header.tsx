    ...
    <header className="fixed top-0 left-0 right-0 bg-gradient-to-r from-teal-500 to-blue-500 shadow-md z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center h-[100px]">
          ...
          <button
            className="ml-4 text-white text-lg py-2 px-6 bg-teal-600 rounded-full shadow-md hover:bg-teal-700 transition duration-300"
            onClick={toggleMenu}
          >
            Меню сайта
          </button>
          ...
          <div className="flex items-center space-x-4">
            <a href="https://t.me/Dm_Pn" target="_blank" rel="noopener noreferrer">
              <FaTelegram className="text-white hover:text-teal-100 transition duration-300" size={30} />
            </a>
            <a href="https://www.instagram.com/sea.wind.travel/" target="_blank" rel="noopener noreferrer">
              <FaInstagram className="text-white hover:text-teal-100 transition duration-300" size={30} />
            </a>
            <a href="https://vk.com/seawind_travel" target="_blank" rel="noopener noreferrer">
              <FaVk className="text-white hover:text-teal-100 transition duration-300" size={30} />
            </a>
            <Link
              href="/auth"
              className="bg-white text-black px-3 py-1 rounded-full hover:bg-teal-100 transition duration-300 text-sm"
            >
              Войти
            </Link>
          </div>
