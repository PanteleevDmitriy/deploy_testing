...
export default function ExcursionCard({ excursion }: ExcursionCardProps) {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md shadow-lg rounded-lg overflow-hidden flex flex-col">
      ...
      <div className="p-4 bg-white/80 backdrop-blur-md rounded-b-lg flex flex-col flex-grow">
        <div className="flex justify-between items-start mb-2 bg-white/80 backdrop-blur-md p-2 rounded">
          <div>
